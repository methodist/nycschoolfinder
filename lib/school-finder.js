...
module.exports = function(app) {
  ...
  function matcher(schooldocs, studentProfile, done) {
    ...
    _.each(schooldocs.rows, function(school) {
      ...
      console.log('checking school:', school.doc.school_name, score);
  ...
  function setupTradeoffAnalysis(matches, done) {
    console.log('setupTradeoffAnalysis on:',matches.length, ' schools');
